...
// import { Container, Typography, List, ListItem, ListItemText, Button, CircularProgress, Box,Alert } from "@mui/material";
...
//       setError(null);
//       try {
//         // Only fetch submissions with status == "pending"
//         const querySnapshot = await getDocs(collection(db, "submissions"));
//         const data = querySnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() }));
//         setSubmissions(data);
//       } catch (err) {
...
//             <ListItemText
//               // primary={`Submission ID: ${submission.id}`}
//               primary={`Borrower Type: ${submission?.borrowerDetails?.borrowerConstitution || 'N/A'}`}
//             />
//             <Button variant="contained" onClick={() => handleViewDetails(submission.id)}>
//               View Details
//             </Button>
//           </ListItem>
//         ))}
